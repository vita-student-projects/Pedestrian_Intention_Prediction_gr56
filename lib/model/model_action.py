...
class ActionHeadClassification(nn.Module):
    def __init__(self, dropout_ratio=0., dim_rep=512, num_classes=2, num_joints=2, hidden_dim=2048):
...
class ActionNet(nn.Module):
    def __init__(self, backbone, dim_rep=512, num_classes=2, dropout_ratio=0., hidden_dim=2048, num_joints=19):
        ...
        self.head = ActionHeadClassification(dropout_ratio=dropout_ratio, dim_rep=dim_rep, num_classes=num_classes, num_joints=num_joints, hidden_dim=hidden_dim)
